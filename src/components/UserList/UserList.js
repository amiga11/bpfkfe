  ...
  return (
    <div className="gpt3__home section__padding" id="home">
      <div className="gpt3__home-content">
        <h1 className="gradient__text">List Instansi yang Sudah di Validasi </h1>
                ...
                {dataInstitusi.map((value, index) => {
                  ...
                  return (
                    <tr key={value.id}>
                      ...
                      <td>{value.data_institusi.jenis_user.jenis_user}</td>
                      <td>{value.data_institusi.kode_institusi}</td>
                      <td>{value.data_institusi.nama_institusi}</td>
                      <td>{value.data_institusi.alamat}</td>
                      <td>{value.nama}</td>
                      <td>{value.email}</td>
                      <td>{value.data_institusi.no_telp}</td>
                    </tr>
                  )
                })}
              </tbody>
